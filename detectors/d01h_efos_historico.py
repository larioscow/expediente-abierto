...
from detectors.common import OUT, RAW, csv_reader, utf8_copy, EFOS_COLS, sql_name_norm as name_norm
...
def main():
    ...
    ORDER BY iniciado_despues_definitivo DESC, importe_num DESC NULLS LAST, codigo_contrato""")
